 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_content']['gp_protection_legend']   = 'Geo Protection';

/**
 * Fields
 */
$GLOBALS['TL_LANG']['tl_content']['gp_protected']           = array('Enable geo protection','Show or hide the content element in selected countries.');
